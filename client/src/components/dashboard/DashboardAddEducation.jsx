...
const DashboardAddEducation = ({ setEducations }) => {
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-slate-400">
                    Create a new educational entry for your portfolio
                  </p>
                </div>
                <Link
              ...
              <div className="relative">
                <div className="backdrop-blur-xl bg-gradient-to-br from-white/10 to-white/5 rounded-3xl border border-white/20 shadow-2xl overflow-hidden">
                  <DashboardFormHeader
                    ...
                    description="Fill in the details about your educational background, achievements, and qualifications"
                  />
                  {/* Tabs */}
                  <DashboardFormTabs
                    activeTab={activeTab}
                      ...
                      >
                        {loadingEducation ? (
                          ...
                          <>
                            ...
                            <span>Create Education Entry</span>
                          </>
                        )}
                      </button>
                    </div>
